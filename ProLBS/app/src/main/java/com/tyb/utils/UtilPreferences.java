...
//    public static UtilPreferences utilPreferences;
//
//    public static UtilPreferences getInstance() {
//        if (utilPreferences == null) {
//            synchronized (UtilPreferences.class) {
//                if (utilPreferences == null) {
//                    // 使用双重同步锁
//                    utilPreferences = new UtilPreferences();
//                }
//            }
//        }
//        return utilPreferences;
//    }
//
...
//    }
	...
	/**
	 * Whether to isEnable for the first time
	 *
	 * @return
	 */
	...
	/**
	 * set user first isEnable is false
	 *
	 * @return
	 */
